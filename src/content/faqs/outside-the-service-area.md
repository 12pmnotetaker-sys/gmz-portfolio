---
question: 'My property is outside the towns you list. Will you still come out?'
short: 'Outside the service area'
...
Maintenance is stricter than the mileage suggests, and the reason is the route rather than the money. Maintenance runs on fixed service days, with stops grouped so a truck makes one trip out and works its way along. A property well away from any existing route means a truck leaving the route and coming back to it, which costs considerably more than the extra distance looks like it should. So for regular upkeep the honest answer is sometimes no well inside forty miles. We would rather tell you that than take the account and become the company that keeps arriving late.

If you are near the list, ask. You will get a straight answer on the first call.
